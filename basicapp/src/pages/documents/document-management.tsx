...
import type { FieldError, UserDocument } from "@/interfaces/interfaces";
...
export default function DocumentManagement() {
  ...
  const handleDelete = (document: UserDocument) => {
  ...
  return (
    <>
      <CrudList
        ...
        onAdd={() =>
          navigate("/uploads/document?redirectUrl=/account/documents")
        }
